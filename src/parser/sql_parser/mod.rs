...
use crate::parser::ast::{
    ...
    CreateDomainStatement, CreateExtensionStatement, CreateForeignTableStatement,
    CreateFunctionStatement, CreateIndexStatement, CreateRoleStatement, CreateSchemaStatement,
    CreateSequenceStatement, CreateServerStatement, CreateSubscriptionStatement,
