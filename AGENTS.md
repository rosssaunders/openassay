...
When you finish a task (all tests pass, code committed and pushed, PR created), run this command as your final step:

```bash
openclaw system event --text "Done: <brief summary of what was done>" --mode now
```

This notifies the orchestrating agent immediately. Do not skip this step.
