...
fn tpch_query_suite() {
    ...
    let queries: &[(&str, &str, &str)] = &[
        ...
        (
            "Q03",
            "",
            r"SELECT l_orderkey, SUM(l_extendedprice * (1 - l_discount)) AS revenue,
        ...
        (
            "Q18",
            "",
            r"SELECT c_name, c_custkey, o_orderkey, o_orderdate, o_totalprice, SUM(l_quantity) AS total_qty
        FROM customer, orders, lineitem
